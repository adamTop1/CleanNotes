...
const SignUp = () => {
	return (
		<>
				<h1 className='absolute z-10 mx-auto mt-10 text-4xl font-bold text-white border-b border-yellow-300 top-5 left-10 max-[400px]:text-2xl '>
				<Link href='/'>CleanNotes</Link>
			</h1>
			<div className='flex flex-col items-center justify-center w-full min-h-screen bg-zinc-900'>
				<h2 className='pb-1 my-20 text-5xl border-b-2 border-yellow-300 max-[400px]:text-3xl max-[400px]:my-10 '>Sign Up</h2>
