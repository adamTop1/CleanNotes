		...
		<div className='sticky top-0 flex flex-col justify-between w-2/12 h-screen border-r-2 border-yellow-300 '>
            ...
            <nav className='mt-32'>
                <ul className='flex flex-col items-center w-full gap-4 text-xl '>
                    <li><Link href='/notes' className='duration-300 border-b border-gray-500 hover:border-yellow-300'>All notes</Link></li>
                    <li><Link href='/notes/favorites' className='text-yellow-300 duration-300 border-b border-gray-500'>Favorite notes</Link></li>
